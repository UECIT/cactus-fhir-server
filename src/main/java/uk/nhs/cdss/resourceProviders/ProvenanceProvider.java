...
public class ProvenanceProvider implements IResourceProvider {
	...
	@Create
	public MethodOutcome createProvenance(@ResourceParam Provenance provenance) {
		return new MethodOutcome(new IdType(resourceService.save(provenance).getId()), true);
	}
}
